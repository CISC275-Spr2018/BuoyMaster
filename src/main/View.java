...
public class View extends JFrame{
	 ...
	 * 
	 */
	public void update(int bX, int bY, int dX, int dY, int pX, int pY, VesselType vessel, double rotationAngle, SandBarCollection sbc, String message, String timerMessage, WakeCollection wc, int sLX, int sLY){ //this method should take something other than the entire model object //// TO DO!!!!!!!!
		estuaryScreen.update( bX,  bY,  dX,  dY,  pX,  pY,  vessel,  rotationAngle,  sbc,  message,  timerMessage,  wc,  sLX,  sLY);
