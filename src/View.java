...
public class View extends JFrame{
	 ...
	 * 
	 */
	public void update(int bX, int bY, int dX, int dY, int pX, int pY, VesselType vessel, double drawAngle, SandBarCollection sbc, String message, String timerMessage, WakeCollection wc, int sLX, int sLY, Direction direction){ //this method should take something other than the entire model object //// TO DO!!!!!!!!
		if(pX>1190) { 
			pX=1190;
